...
class Match extends Model {
     ...
     * 
     */
    public function editMatchTeams($leagueId) {
    ...
    public static function getAvailableTeams($leagueId, $teamId) {
        $query = self::unavailable()
...
//        public static function getAvailableEditTeams($leagueId, $homeId, $guestId) {
//     $query = self::unavailable()
//                 ->where([['home_id', '=', $homeId],['guest_id','<>',$guestId], ['matches.league_id', '=', $leagueId]])
//                ->pluck('id');
//        return Team::whereNotIn('id', $query)
//                        ->where([['id', '<>', $homeId], ['teams.league_id', '=', $leagueId]])
//                        ->get();
//    }

    /*
     * matches played as home team
     */
    ...
    public function getTeamDebt($teamId) {
