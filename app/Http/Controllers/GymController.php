...
class GymController extends Controller
{
    ...
    public function showReport()
    {
        ...
        $totalGym['matches'] = Match::count();
        $totalGym['sum_rent'] = Gym::getSumRent();
        $totalGym['sum_fees'] = Gym::getSumFees();
        $totalGym['sum_expenses'] = Gym::getSumExpenses();
        $totalGym['diff'] = Gym::getTotalDifference();
    ...
    public function filterReport()
    {
        ...
        foreach ($gyms as $gym) {
            ...
            $response[$gym->id]['difference'] = $response[$gym->id]['amount_fees']
                - $response[$gym->id]['total_expenses'] - $response[$gym->id]['total_rent'];
    ...
    {
        $gyms = Gym::all();
        return view('gyms.all-gyms', compact('gyms'));
    }
