...
Route::group(['middleware' => ['auth']], function() {
    ...
    //matches
    Route::get('gyms/{gym}/matches','MatchController@index');
    ...
    //on date select matches and exp
    Route::post('gyms/{gym}/on-date',['uses'=>'MatchController@reloadOnDate','as'=>'matches.reload']);
    //check team balance
