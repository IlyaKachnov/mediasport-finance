...
@section('table-content')
    ...
    <div class="portlet light portlet-fit bordered">
        <div class="row-fluid clearfix margin-bottom-10 margin-top-20">
            <form class="form-horizontal" method="GET" action="{{route('matches.index',$gym)}}">
                <div class="col-lg-2 col-xs-6">
                    <div id="main-date" class="input-group date" data-date-format="dd-mm-yyyy">
                        <input type="text" name="main_date" id="global-date" class="form-control form-filter input-sm"
                               value="{{isset($selectedDate)?$selectedDate:\Carbon\Carbon::today()->format('d-m-Y')}}"
                               readonly>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <a href="{{action('MatchController@index',$gym)}}" class="btn btn-sm blue-soft" role="button">Текущая
                        дата</a>
                </div>
            </form>
        </div>
        <div class="portlet-body">
            <div class="portlet light portlet-fit bordered">
                ...
                <div id="match-error" class="alert alert-danger display-hide" style="margin:1%;">Не все поля заполнены
                    или есть ошибки!
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a id="sample_editable_1_new" data-gym="{{$gym->id}}"
                                       href="{{action('MatchController@index',$gym)}}" class="btn green"> Добавить
            ...
            <div class="portlet light portlet-fit bordered">
                ...
                <div id="exp-error" class="alert alert-danger display-hide" style="margin:1%;">Выделенные поля должны
                    быть заполнены!
                    <button class="close" data-close="alert"></button>
                </div>
                <div class="portlet-body">
